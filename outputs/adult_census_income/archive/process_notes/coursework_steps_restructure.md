# Iteration 2 Kickoff: Fit Iteration 1 Into Coursework Step Headings

This document starts **Iteration 2** by consolidating all Iteration 1 work under the exact six headings from the coursework brief.
